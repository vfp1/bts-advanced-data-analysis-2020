...
class HousingPipeline(object):
    def __init__(self, housing_numeric, housing_categoric, housing_full):
        self.housing_numeric = housing_numeric
        self.housing_categoric = housing_categoric
        self.housing_full = housing_full
    ...
    def full_pipeline(self):
        ...
        housing_num_tr = num_pipeline.fit_transform(self.housing_numeric)
        ...
        housing_prepared = full_pipeline.fit_transform(self.housing_full)
